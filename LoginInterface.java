...
public class LoginInterface {
    public static void showLogIn(){
            ...
            try{
                    ...
                    JLabel emaillError = new JLabel("");
                    emaillError.setForeground(new Color(logInPanel.getBackground().getRed(), logInPanel.getBackground().getGreen(), logInPanel.getBackground().getBlue(),0));
                    logInPanel.add(emaillError, gbc);
                    gbc.gridy++;
                    ...
                    logInButton.addActionListener(new ActionListener() {
                            ...
                            public void actionPerformed(ActionEvent e) {
                                    ...
                                    handleLogin(emailField, passwordField, emaillError, passwordError, logInPanel);
                            }
                    });
                    gbc.gridy++;
